...
<html>
    ...
    <link rel="stylesheet" href="<?php echo $assetsUrl.'/VOID-4489a9fac4.css'; ?>">
    ...
    <script src="<?php echo $assetsUrl.'/bundle-header-dee2544709.js'; ?>"></script>
    ...
    <script src="<?php echo $assetsUrl.'/header-1c723bfe8c.js'; ?>"></script>
